...
export default function Page() {
  return (
    <div className="space-y-6 animate-fade-in">
      <h1 className="page-title text-3xl font-black text-slate-800">Quản lý Nguồn vốn</h1>
      <div className="card p-16 flex flex-col items-center justify-center text-center space-y-6 mt-8 shadow-xl border-dashed border-2 border-slate-300">
        ...
        <p className="text-xl text-slate-500 font-medium max-w-lg">Module <strong>Quản lý Nguồn vốn</strong> đang trong quá trình phát triển. Vui lòng quay lại sau!</p>
      </div>
    </div>
  );
}
